...
def alianza_equilibrada(string):
    r_count = string.lower().count('r')  # Contar 'R' y 'r'
    j_count = string.lower().count('j')  # Contar 'J' y 'j'
    return r_count == j_count  # Retornar True si son iguales, False en caso contrario

print(alianza_equilibrada("Reed Richards y Johnny Storm"))  #False
print(alianza_equilibrada("RRJJ"))  # True